    ...
    return (
      <div className="flex-1 overflow-y-auto space-y-6 p-4 lg:p-8">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground">
              {selectedSubmission.requestId} ·{" "}
              {formatDistanceToNow(toDate(selectedSubmission.submittedAt), {
                addSuffix: true,
              })}
            </p>
          </div>
        ...
        <div className="rounded-xl border border-border bg-card p-4 lg:p-6">
          <Stepper
            steps={stepLabels}
            currentStep={selectedSubmission.currentStep}
          />
        </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <dd className="text-sm font-medium text-foreground">
                  {flow?.title ?? selectedSubmission.processType}
                </dd>
              </div>
            </div>
            <div className="flex items-start gap-2">
